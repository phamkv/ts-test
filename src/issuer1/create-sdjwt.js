...
const jwt = path.resolve(__dirname, "../utils/sd-jwt/examples/thing1_jwt.json") // demo path
const hashAlg = "sha-256";
const sdClaims = path.resolve(__dirname, "../utils/sd-jwt/examples/thing1_sdClaimsFlat.json") // demo path
